...
@Component({
  selector: 'app-competencia2',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './competencia2.component.html',
  styleUrl: './competencia2.component.css'
})
export class Competencia2Component implements OnInit {
  constructor(private router: Router) {}
  correctAnswers = ['C', 'B', 'A', 'A', 'D', 'B', 'A', 'D', 'A', 'C']; //ESTAS SON LAS RESPUESTAS CORRECTAS DE LAS PREGUNTAS
