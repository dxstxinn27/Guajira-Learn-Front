...
@Component({
  ...
  templateUrl: './humanidades.component.html',
  styleUrl: './humanidades.component.css'
})
export class HumanidadesComponent implements OnInit {
  constructor(private router: Router) {}
  correctAnswers = ['B', 'B', 'C', 'C', 'C', 'B', 'B', 'C', 'B', 'A']; //ESTAS SON LAS RESPUESTAS CORRECTAS DE LAS PREGUNTAS
